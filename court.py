...
def get_data2(Param, Index, Page, Order, Direction):
    guid = get_guid()
    number = get_number(guid)
    vjkl5 = get_vjkl5(guid, number, Param)
    vl5x = get_vl5x(vjkl5)
    ...
    # 获取数据
    url3 = "http://wenshu.court.gov.cn/CreateContentJS"
    headers2 = {
        "Accept": "*/*",
        "Accept-Encoding": "gzip, deflate",
        "Accept-Language": "zh-CN,zh;q=0.8",
    ...
    req3 = session.get(url=url3, headers=headers2)
...
def main():
    ...
    get_data2(Param, Index, Page, Order, Direction)
